...
export class _TemplatePlayer extends BasePlayer {
  constructor(scene: Phaser.Scene, x: number, y: number) {
    ...
    const config: PlayerConfig = {
      ...
      // TEXTURE KEY
      // ========================================
      // The player's index.json slot key. The Preloader placeholder-fills it,
      // so any valid key renders pre-art. (For directional art, W4 may switch
      // this to a {name}_idle_front IMAGE key.)
      textureKey: 'player', // TODO-W4: replace with your player's index.json slot key
